...
import { CalendarIcon, School, Users, Calendar, Save, Check } from 'lucide-react'
    ...
    return (
        <div className="p-6 min-h-screen" style={{
            ...
            <div className="flex flex-col space-y-2 mb-8">
                <h1 className="text-3xl font-bold text-blue-900">학급 설정</h1>
                <p className="text-slate-600">학급 정보를 관리할 수 있습니다.</p>
            </div>
            ...
            <div className="grid grid-cols-1 gap-6 max-w-3xl">
                ...
                {/* 기본 정보 설정 */}
                <Card className="bg-white/90 backdrop-blur-sm shadow-md p-6 rounded-lg">
